return {
  -- TypeScript/JavaScript 语言支持推荐函数
  -- 这个函数决定在什么情况下应该启用 TypeScript 支持
  -- 它会检查：
  -- 1. 文件类型是否为 JavaScript/TypeScript 相关
  -- 2. 项目根目录是否存在配置文件（tsconfig.json 等）
  recommended = function()
    return LazyVim.extras.wants({
      -- 匹配的文件类型列表
      ft = {
        "javascript",         -- 纯 JavaScript 文件
        "javascriptreact",    -- JavaScript React 组件
        "javascript.jsx",     -- JavaScript JSX 文件
        "typescript",         -- 纯 TypeScript 文件  
        "typescriptreact",    -- TypeScript React 组件
        "typescript.tsx",     -- TypeScript TSX 文件
      },
      -- 项目根目录的标识文件（存在其中任一文件就认为是有意义的项目）
      root = { 
